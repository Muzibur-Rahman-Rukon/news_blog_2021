...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" href="public/admin/assets/images/favicon.ico" type="image/x-icon">
    <!-- Google font-->
        ...
        <div class="container">
                ...
                <div class="col-sm-12">
                    ...
                    {!! Form::open(['url' => '/admin_login_check','method' => 'post']) !!}
                            <div class="text-center">
                                <img src="public/admin/assets/images/auth/logo-dark.png" alt="logo.png">
                            </div>
                            <div class="auth-box">
            ...
            ?>
                                ...
                                <div class="input-group">
                                    <input type="email" class="form-control" name="admin_email_address" placeholder="Your Email Address">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <img src="public/admin/assets/images/auth/Logo-small-bottom.png" alt="small-logo.png">
                                    </div>
                                </div>
...
<![endif]-->
    ...
    <script type="text/javascript" src="{{URL::to('public/admin/assets/js/bootstrap/js/bootstrap.min.js')}}"></script>
...
<script type="text/javascript" src="{{URL::to('public/admin/assets/js/modernizr/modernizr.js')}}"></script>
    <script type="text/javascript" src="{{URL::to('public/admin/assets/js/modernizr/css-scrollbars.js')}}"></script>
    <script type="text/javascript" src="{{URL::to('public/admin/assets/js/common-pages.js')}}"></script>
</body>
